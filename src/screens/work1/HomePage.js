  ...
  const productData = [
    {
      ...
      'Resim Linki':
        'https://misassanalmarket.com/218885-home_default/cola-turka-pet-25lt.jpg',
      urun_fiyati: '₺39,95',
      'İlk Fiyat': '₺39.95',
    ...
    },
    {
      ...
      'Resim Linki':
        'https://cdn2.a101.com.tr/dbmk89vnr/CALL/Image/get/9bD5NoFuaZ_256x256.png',
      urun_fiyati: '₺30,00',
      'İlk Fiyat': '₺30.0',
    ...
    },
    {
      ...
      'Resim Linki':
        'https://misassanalmarket.com/219083-home_default/solen-ozmo-cornet-sutlu-25gr.jpg',
      urun_fiyati: '₺15,50',
      'İlk Fiyat': '₺15.5',
      'İndirim Miktarı': '₺1.2',
      'Son Fiyat': '₺14.3',
    ...
    <View style={{flex: 1}}>
      <ScrollView>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.allseebutton}
            onPress={() => navigation.navigate('aburcuburall')}>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.allseebutton}
            onPress={() => navigation.navigate('icecekall')}>
            <Text style={styles.allsee}>Tümünü Gör</Text>
          </TouchableOpacity>
        </View>
        <View>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.allseebutton}
            onPress={() => navigation.navigate('donukurunall')}>
            <Text style={styles.allsee}>Tümünü Gör</Text>
          </TouchableOpacity>
        </View>
        <View>
        ...
        <View
          ...
          <TouchableOpacity
            style={styles.allseebutton}
            onPress={() => navigation.navigate('etbalıkall')}>
            <Text style={styles.allsee}>Tümünü Gör</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.discountPanel}>
          ...
          {productData.map((product, index) => (
            <View key={index} style={styles.discountItem}>
              <Image
                source={{uri: product['Resim Linki']}}
                style={styles.discountImage}
              />
              <View style={styles.discountInfo}>
                <Text style={styles.discountName}>{product['Ürün Adı']}</Text>
                <Text style={styles.discountPrice}>
                  İndirimli Fiyat: {product['Son Fiyat']}₺
                </Text>
                <Text style={styles.discountPercentage}>
                  İndirim: {product['İndirim Oranı (%)']}%
                </Text>
              </View>
            </View>
          ))}
